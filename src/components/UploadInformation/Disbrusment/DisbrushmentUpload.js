...
import styles from './DisbrushmentUpload.module.css';
...
function DisbrushmentUpload(props) {
            ...
            <Card.Body>
                {/* {(userType == 'fi') &&                  */}
                    <form onSubmit={formik.handleSubmit} autoComplete="off" className="form fv-plugins-bootstrap fv-plugins-framework animated animate__animated animate__backInUp">
                        <div className="row">
                            <div className="col-3">
                                <h4 className="card-title">Disbrushment Agent Information</h4>
                            </div>
                            <div className="col-6">
...
export default DisbrushmentUpload;